...
<html prefix="og: http://ogp.me/ns#" lang="ru-RU" dir="ltr">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="pcss/imsearch.css?14-0-3-1-636797848859800650" media="screen,print" />
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<div id="imHeader">
						<h1 class="imHidden">Поиск - APS</h1>
...
<!-- AddThis Button END -->
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_17_tab0" style="">
		...
		<script type="text/javascript" src="cart/x5cart.js?14-0-3-1-636797848859800650"></script>
